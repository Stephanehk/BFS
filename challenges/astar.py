...
def a_star (maze, current, destination, start, possible_next_steps):
    ...
    a_star (maze, next_step, destination, start, possible_next_steps)
...
#Perfom a star
a_star (weighted_maze, start, destination, start, possible_next_steps)
